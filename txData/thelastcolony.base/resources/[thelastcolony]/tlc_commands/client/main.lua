...
RegisterNetEvent('tlc_commands:freeze', freezePlayer)
...
RegisterNetEvent('tlc_commands:client:repairVehicle', function(vehicleNetId)
...
RegisterNetEvent('tlc_commands:client:spawnVehicle', function(modelName, coords, heading)
