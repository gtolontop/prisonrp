lib.addCommand('freeze', {
    ...
    TriggerClientEvent('gtol_commands:freeze', args.target, true, true)
...
lib.addCommand('thaw', {
    ...
    TriggerClientEvent('gtol_commands:freeze', args.target, false, true)
...
lib.addCommand('car', {
    ...
    TriggerClientEvent('gtol_commands:client:spawnVehicle', playerId, args.model, coords, heading)
end)
...
lib.addCommand({'fix', 'repair'}, {
    ...
    TriggerClientEvent('gtol_commands:client:repairVehicle', targetId, vehicleNetId)
