...
function Props.Remove(containerId)
    ...
    if DoesEntityExist(prop) then
        ...
        exports.prisonrp:RemoveOutline(prop)
        ...
        -- Remove 3D text UI
        local TextUI3D = exports.prisonrp:GetTextUI3D()
...
local function StartFadeIn(entity, color)
    if not fadingProps[entity] then
        ...
        exports.prisonrp:AddOutline(entity, {r = color.r, g = color.g, b = color.b, a = 0}, 1)
    else
...
local function StartFadeOut(entity)
    if fadingProps[entity] then
        ...
        exports.prisonrp:RemoveOutline(entity)
    end
end
...
local function UpdateFadeColor(entity, color)
    if fadingProps[entity] then
        ...
        -- Update immediately
        exports.prisonrp:UpdateOutlineColor(entity, {
            r = color.r,
            g = color.g,
            b = color.b,
            a = currentAlpha
